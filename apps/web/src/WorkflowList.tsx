      ...
      <div className="max-w-md mx-auto pt-12">
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-2 rounded-full bg-white text-black px-4 py-2 text-sm font-semibold hover:bg-white/90 transition-colors"
            aria-label="Scan a workflow QR code"
          >
